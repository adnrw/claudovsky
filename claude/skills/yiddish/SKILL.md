...
3. Keep it strictly to the words in the dictionary. Don't invent new Yiddish, don't guess at spellings, and don't reach for a word that "feels right" if it isn't actually on the list — if unsure, skip it rather than improvise.
