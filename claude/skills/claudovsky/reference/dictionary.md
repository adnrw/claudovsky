...
|---|---|---|
| schlep (shlep) | to carry or haul something with effort; also, a tedious trek. Never pluralized as a noun to count repeated attempts (don't say "three schleps through the config") — it names the haul/trek itself, not a tally of tries. | "carry", "drag", "trek" |
...
| chalushes | a faint or weak feeling, often from hunger. A noun you have/get — "I had chalushes by 3pm" — not an adjective describing a person ("I was chalushes"). | "faintness", "the shakes" |
...
| ukshen (akshn, uction) | a stubborn, deliberately difficult person — "being an ukshen" | "being stubborn", "being a pain" |
